namespace Elementary.Memoization.Test
{
    ...
    [TestFixture]
    public class Memoization_2P_Delegates_notTS_Test
    {
        ...
        [Test]
        public void Memoization_2P_Delegates_notTS_function_is_called_for_unknown_parameters()
        {
            // ACT & ASSERT
        ...
        [Test]
        public void Memoization_2P_Delegates_notTS_function_is_not_called_fown_known_parameters()
        {
            // ARRANGE

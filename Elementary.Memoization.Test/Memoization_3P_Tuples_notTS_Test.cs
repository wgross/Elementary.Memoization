namespace Elementary.Memoization.Test
{
    ...
    public class Memoization_3P_Tuples_notTS_Test
    {
        ...
        [Test]
        public void Memoization_3P_Tuples_notTS_function_is_called_for_unknown_parameters()
        {
            // ACT & ASSERT
        ...
        [Test]
        public void Memoization_3P_Tuples_notTS_function_is_called_twice_for_known_parameters()
        {
            // ARRANGE

namespace Elementary.Memoization.Test
{
    ...
    [TestFixture]
    public class Memoization_1P_notTS_Test
    {
        ...
        [Test]
        public void Memoization_1P_notTS_function_is_called_once()
        {
            // ACT
        ...
        [Test]
        public void Memoization_1P_notTS_function_is_not_called_twice_for_same_parameter()
        {
            // ARRANGE
        ...
        [Test]
        public void Memoization_1P_notTS_function_is_called_again_for_different_parameter()
        {
            // ARRANGE
